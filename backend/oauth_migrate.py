...
if __name__ == '__main__':
    ...
    try: changed=apply_migration()
        ...
        print('FAIL: OAuth migration not confirmed; no secrets printed.');raise SystemExit(1)
    print('PASS: OAuth schema created.' if changed else 'PASS: OAuth schema already applied.')
