...
def read_request(value=None):
    ...
    need(value['operation'] in ('hold', 'inspect', 'deploy', 'configure-internal-login', 'inspect-edge', 'stage-edge', 'stage-edge-naver', 'rollout-edge-code', 'stage-account-code', 'stage-account-enabled', 'inspect-account-enabled', 'stage-marketing-enabled', 'inspect-marketing-enabled'), 'unsupported_operation')
